...
class ComplicationDrawable : Drawable {
    ...
    val activeStyle: ComplicationStyle

    /** Returns complication style for ambient mode. */
    val ambientStyle: ComplicationStyle
    ...
    var isInAmbientMode: Boolean = false
     ...
     */
    var isBurnInProtectionOn: Boolean = false
    ...
    constructor(drawable: ComplicationDrawable) {
     ...
     */
    var complicationData: ComplicationData = NoDataComplicationData()
        private set
     ...
     */
    fun onTap(@Px x: Int, @Px y: Int): Boolean {
     ...
     */
    var noDataText: CharSequence? = null
        set(noDataText) {
